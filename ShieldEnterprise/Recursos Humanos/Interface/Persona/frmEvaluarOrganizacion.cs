...
{
    public partial class frmEvaluarOrganizacion : Form
    {
        public frmEvaluarOrganizacion(int a1, int a2, int a3, int a4, int a5)
        {
            InitializeComponent();
            this.a1 = a1;
            this.a2 = a2;
        ...
        private void btnsig_Click(object sender, EventArgs e)
        {
            if (c1.Checked == true || c2.Checked == true || c3.Checked == true || c4.Checked == true || c5.Checked == true )
            {
                if (ca1.Checked == true || ca2.Checked == true || ca3.Checked == true || ca4.Checked == true || ca5.Checked == true )
                {
                    ...
                    {
                        frmDatosEvaluacion d = new frmDatosEvaluacion(a1,a2,a3,a4,a5);
                        d.txtid.Text = txtid.Text; 
                        d.txtape.Text = txtapell.Text;
        ...
        //{
        //    frmEvaluarTrabajo d = new frmEvaluarTrabajo();
        //    d.Show();
        //    this.Hide();  
